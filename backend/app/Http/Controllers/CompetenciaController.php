...
{
    $areas = Competencia::select('areacompetencia')
        ->distinct()
        ->orderBy('areacompetencia')
        ->pluck('areacompetencia');

    return response()->json($areas);
}

public function getNivelesPorArea(Request $request): JsonResponse
{
    $area = $request->query('area');
    ...
    $niveles = Competencia::where('areacompetencia', $area)
        ->select('nivelcompetencia')
        ->distinct()
        ->orderBy('nivelcompetencia')
        ->pluck('nivelcompetencia');
