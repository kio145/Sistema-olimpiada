...
//Competencias
Route::get('/competencias/areas', [CompetenciaController::class, 'getAreas']);
Route::get('/competencias/niveles', [CompetenciaController::class, 'getNivelesPorArea']);
...
Route::post('/inscribir/{idcompetencia}', [InscripcionController::class, 'registrar']);
